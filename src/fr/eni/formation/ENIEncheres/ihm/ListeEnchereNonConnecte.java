...
/**
 * Servlet implementation class ListeEnchereNonConnecte
 */
@WebServlet("/ListeEnchereNonConnecte")
public class ListeEnchereNonConnecte extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListeEnchereNonConnecte() {
        super();
